...
def create_app(test_config=None):
    ...
    def retrive_appointments_donors(auth):
        ...
        selection = AppointmentsDonors.query.order_by(
            AppointmentsDonors.id).all()
    ...
    def create_donation_center(auth):
        ...
        try:
            if new_name and new_address:
                ...
                selection = DonationCenter.query.order_by(
                    DonationCenter.id).all()
    ...
    def create_AppointmentsDonors(auth):
        ...
        try:
            if new_donor_id and new_appointment_id:
                ...
                selection = AppointmentsDonors.query.order_by(
                    AppointmentsDonors.id).all()
                current_appointmentsDonors = paginate_results(
                    request, selection)
